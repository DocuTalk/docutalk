const ButtonSvg = (white, red) => (
  <>
    ...
    >
      <path
        fill={white ? "white" : red ? "#ef4444" : "none"}
        stroke={white ? "white" : red ? "#ef4444" : "url(#btn-left)"}
        strokeWidth="2"
    ...
    >
      <path
        fill={white ? "white" : red ? "#ef4444" : "none"}
        stroke={white ? "white" : red ? "#ef4444" : "url(#btn-right)"}
        strokeWidth="2"
